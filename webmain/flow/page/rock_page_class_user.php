...
$(document).ready(function(){
	{params}
	var modenum = 'class_user',modename='分类',isflow=0,modeid='94',atype = params.atype,pnum=params.pnum,modenames='';
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"}],fieldsselarr= [];
	...
	var c = {
		...
		getacturl:function(act){
			return js.getajaxurl(act,'mode_class_user|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistclass_user = a;
			addtabs({num:'daoruclass_user',url:'flow,input,daoru,modenum=class_user',icons:'plus',name:'导入分类'});
		},
	...
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('Y2xhc3NfdXNlcg::'),
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewclass_user_{rand}').bootstable(bootparams);
	c.init();
...
<div id="viewclass_user_{rand}"></div>
<!--HTMLend-->