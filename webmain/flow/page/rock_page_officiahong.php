...
$(document).ready(function(){
	{params}
	var modenum = 'officiahong',modename='发文套红',isflow=0,modeid='90',atype = params.atype,pnum=params.pnum,modenames='';
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"gwid","name":"\u5957\u7ea2\u516c\u6587","fieldstype":"select","ispx":"0","isalign":"0","islb":"0"},{"fields":"officiatitle","name":"\u62ac\u5934\u540d\u79f0","fieldstype":"selectdatatrue","ispx":"0","isalign":"0","islb":"1"},{"fields":"gwtitle","name":"\u5957\u7ea2\u516c\u6587","fieldstype":"hidden","ispx":"0","isalign":"0","islb":"1"},{"fields":"mbid","name":"\u4f7f\u7528\u6a21\u7248","fieldstype":"select","ispx":"0","isalign":"0","islb":"0"},{"fields":"mbtitle","name":"\u4f7f\u7528\u6a21\u7248","fieldstype":"hidden","ispx":"0","isalign":"0","islb":"1"},{"fields":"optname","name":"\u64cd\u4f5c\u4eba","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"optdt","name":"\u64cd\u4f5c\u65f6\u95f4","fieldstype":"datetime","ispx":"1","isalign":"0","islb":"1"},{"fields":"temp_hongcont","name":"\u7ea2\u5934\u6587\u4ef6","fieldstype":"text","ispx":"0","isalign":"0","islb":"0"}],fieldsselarr= [];
	...
	var c = {
		...
		getacturl:function(act){
			return js.getajaxurl(act,'mode_officiahong|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistofficiahong = a;
			addtabs({num:'daoruofficiahong',url:'flow,input,daoru,modenum=officiahong',icons:'plus',name:'导入发文套红'});
		},
	...
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('b2ZmaWNpYWxob25n'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"抬头名称",dataIndex:"officiatitle"},{text:"套红公文",dataIndex:"gwtitle"},{text:"使用模版",dataIndex:"mbtitle"},{text:"操作人",dataIndex:"optname"},{text:"操作时间",dataIndex:"optdt",sortable:true},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewofficiahong_{rand}').bootstable(bootparams);
	c.init();
...
<div id="viewofficiahong_{rand}"></div>
<!--HTMLend-->