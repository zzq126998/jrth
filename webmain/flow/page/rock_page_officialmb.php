<?php
/**
*	模块：officialmb.红头文件模版
*	说明：自定义区域内可写你想要的代码
*	来源：流程模块→表单元素管理→[模块.红头文件模版]→生成列表页
*/
...
$(document).ready(function(){
	{params}
	var modenum = 'officialmb',modename='红头文件模版',isflow=0,modeid='89',atype = params.atype,pnum=params.pnum,modenames='';
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"title","name":"\u6a21\u7248\u6807\u9898","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"fenlei","name":"\u5206\u7c7b","fieldstype":"rockcombo","ispx":"1","isalign":"0","islb":"1"},{"fields":"recename","name":"\u53ef\u4f7f\u7528\u4eba","fieldstype":"changedeptusercheck","ispx":"0","isalign":"0","islb":"1"},{"fields":"content","name":"\u6a21\u7248\u5185\u5bb9","fieldstype":"htmlediter","ispx":"0","isalign":"0","islb":"0"},{"fields":"status","name":"\u72b6\u6001","fieldstype":"select","ispx":"1","isalign":"0","islb":"1"},{"fields":"sort","name":"\u6392\u5e8f\u53f7","fieldstype":"number","ispx":"1","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		getacturl:function(act){
			return js.getajaxurl(act,'mode_officialmb|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistofficialmb = a;
			addtabs({num:'daoruofficialmb',url:'flow,input,daoru,modenum=officialmb',icons:'plus',name:'导入红头文件模版'});
		},
	...
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('b2ZmaWNpYWxtYg::'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"模版标题",dataIndex:"title"},{text:"分类",dataIndex:"fenlei",sortable:true},{text:"可使用人",dataIndex:"recename"},{text:"状态",dataIndex:"status",sortable:true},{text:"排序号",dataIndex:"sort",sortable:true},{text:"说明",dataIndex:"explain"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewofficialmb_{rand}').bootstable(bootparams);
	c.init();
...
<div id="viewofficialmb_{rand}"></div>
<!--HTMLend-->