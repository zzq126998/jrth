...
*	模块：officifa.公文分发传阅
*	说明：自定义区域内可写你想要的代码
*	来源：流程模块→表单元素管理→[模块.公文分发传阅]→生成列表页
*/
...
$(document).ready(function(){
	{params}
	var modenum = 'officifa',modename='公文分发传阅',isflow=0,modeid='91',atype = params.atype,pnum=params.pnum,modenames='';
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"applydt","name":"\u5206\u53d1\u65e5\u671f","fieldstype":"date","ispx":"1","isalign":"0","islb":"1"},{"fields":"num","name":"\u516c\u6587\u7f16\u53f7","fieldstype":"text","ispx":"1","isalign":"0","islb":"1"},{"fields":"title","name":"\u5bf9\u5e94\u516c\u6587","fieldstype":"selectdatafalse","ispx":"0","isalign":"0","islb":"1"},{"fields":"unitsame","name":"\u53d1\u6587\u5355\u4f4d","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"gwid","name":"\u5bf9\u5e94\u516c\u6587","fieldstype":"hidden","ispx":"0","isalign":"0","islb":"0"},{"fields":"recename","name":"\u5206\u53d1\u7ed9","fieldstype":"changedeptusercheck","ispx":"0","isalign":"0","islb":"1"},{"fields":"startdt","name":"\u67e5\u9605\u65e5\u671f","fieldstype":"date","ispx":"0","isalign":"0","islb":"1"},{"fields":"enddt","name":"\u622a\u6b62\u65e5\u671f","fieldstype":"date","ispx":"0","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"},{"fields":"optname","name":"\u64cd\u4f5c\u4eba","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"optdt","name":"\u64cd\u4f5c\u65f6\u95f4","fieldstype":"datetime","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		getacturl:function(act){
			return js.getajaxurl(act,'mode_officifa|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistofficifa = a;
			addtabs({num:'daoruofficifa',url:'flow,input,daoru,modenum=officifa',icons:'plus',name:'导入公文分发传阅'});
		},
	...
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('b2ZmaWNpYWxmYQ::'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"分发日期",dataIndex:"applydt",sortable:true},{text:"公文编号",dataIndex:"num",sortable:true},{text:"对应公文",dataIndex:"title"},{text:"发文单位",dataIndex:"unitsame"},{text:"分发给",dataIndex:"recename"},{text:"查阅日期",dataIndex:"startdt"},{text:"截止日期",dataIndex:"enddt"},{text:"说明",dataIndex:"explain"},{text:"操作人",dataIndex:"optname"},{text:"操作时间",dataIndex:"optdt"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewofficifa_{rand}').bootstable(bootparams);
	c.init();
