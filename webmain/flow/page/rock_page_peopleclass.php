...
$(document).ready(function(){
	{params}
	var modenum = 'peopleclass',modename='人员分类',isflow=0,modeid='94',atype = params.atype,pnum=params.pnum,modenames='user';
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"typename","name":"\u5206\u7c7b","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		getacturl:function(act){
			return js.getajaxurl(act,'mode_peopleclass|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistpeopleclass = a;
			addtabs({num:'daorupeopleclass',url:'flow,input,daoru,modenum=peopleclass',icons:'plus',name:'导入人员分类'});
		},
	...
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('cGVvcGxlX2NsYXNz'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"分类",dataIndex:"typename"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewpeopleclass_{rand}').bootstable(bootparams);
	c.init();
...
<div id="viewpeopleclass_{rand}"></div>
<!--HTMLend-->