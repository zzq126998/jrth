...
homeobject.show_officic_list=function(a){
	...
	for(i=0;i<a.length;i++){
		...
		s+='<a temp="list" style="color:'+col+';TEXT-DECORATION:none" onclick="openxiangs(\'公文查阅\',\'officic\',\''+a1.id+'\');" class="list-group-item">◇ ['+a1.num+'] '+a1.title+'</a>';
	}
...
<div class="list-group-item  list-group-item-danger">
	<i class="icon-suitcase"></i> <?=$itemnowname?>
	<a style="float:right;TEXT-DECORATION:none" onclick="moreofficic();">更多&gt;&gt;</a>
</div>
</div>